...
"""
Adapted script for clinical BHC fine-tuning, for Abstractive BART with Guidance fine-tuning. 
"""
...
#         raw_datasets = load_dataset(extension, data_files=data_files, cache_dir=model_args.cache_dir)
    ...
    ds['train'].sort('text_embed_len', reverse=True)
    val_test_ds = ds['test'].train_test_split(train_size=0.5, test_size=0.5, shuffle=False)
    val_ds = val_test_ds['train'].sort('text_embed_len', reverse=True)
    test_ds = val_test_ds['test'].sort('text_embed_len', reverse=True)
